			...
			<div className="container">
				<div className="fugu--footer-top">
					<div className="fugu--default-content content-black">
						...
						Join our community to stay updated on future airdrops and secure your chance to buy insurance at launch. Be part of the decentralized insurance revolution and gain exclusive benefits!
						</p>
						<div className="fugu--btn-wrap wow fadeInUpX" data-wow-delay="0.25s">
							<Link href={"#"} legacyBehavior>
								<a className="fugu--btn bg-orange">Join Our Telegram</a>
							</Link>
						</div>
					...
					<div className="row">
						...
						<div className="col-xl-6 col-lg-8">
							<div className="fugu--footer-menu2">
								<ul>
									<li>
										<Link href={"contact.html"}> Home </Link>
									</li>
									<li>
										<Link href={"contact.html"}> airdrops </Link>
									</li>
									<li>
										<Link href={"contact.html"}> roadmap </Link>
									</li>
									<li>
				...
				<div className="fugu--footer-bottom fugu--footer-bottom2">
					<div className="row">
						<div className="col-lg-6">
							<p>&copy; Copyright 2024, All Rights Reserved by Dultr</p>
						</div>
						<div className="col-lg-6">
