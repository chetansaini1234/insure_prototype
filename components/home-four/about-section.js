				...
				<div className="row">
					<div className="col-xl-4 col-lg-4">
						<div className="fugu--swiper-slider-wrap">
							...
							<img src="/images/all-img/v4/secure_icon.png" alt="Secure Icon" />

								{/* <Swiper effect={"cards"} grabCursor={true} modules={[EffectCards]} className="mySwiper">
									<SwiperSlide>
										<div className="fugu--card-thumb">
													<img src="/images/all-img/v4/secure_icon.png" alt="" />
												</div>
					...
					<div className="col-xl-5 offset-xl-2 col-lg-7 offset-lg-1 d-flex align-items-center">
						<div className="fugu--default-content content-black">
							<h2>Insurance That Goes Above And Beyond</h2>
							<p>
							Our blockchain-based life insurance platform uses smart contracts and oracles for secure, efficient, and transparent coverage. Premiums in I tokens are burned to increase value; claims are verified by oracles and paid in new tokens.
							</p>
