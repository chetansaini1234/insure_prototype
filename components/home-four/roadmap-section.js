			...
			<div className="container">
				<div className="fugu--section-title">
					<div className="fugu--default-content content-black">
						<h2>The Roadmap</h2>
						<p>
							A Insure roadmap is a strategic planning tool used to set desired outcomes, milestones into the
							support.
						</p>
					</div>
				</div>
				<div className="row">
					...
					<div className="col-xl-3 col-md-6">
						<div className="fugu--iconbox-wrap wow fadeInUpX" data-wow-delay="0.10s">
							...
							<div className="fugu--iconbox-data">
								<h4>Phase 2</h4>
								<span>Reveal Marketing & Airdrops🚀</span>
								<p>Starting marketing and multiple partnerships </p>
							</div>
						</div>
					</div>
					<div className="col-xl-3 col-md-6">
						<div className="fugu--iconbox-wrap wow fadeInUpX" data-wow-delay="0.20s">
							...
							<div className="fugu--iconbox-data">
								...
								<p>Splitting up Airdrops may increase to the value of the asset for the owner</p>
							</div>
						</div>
					</div>
					<div className="col-xl-3 col-md-6">
						<div className="fugu--iconbox-wrap wow fadeInUpX" data-wow-delay="0.30s">
							...
							<div className="fugu--iconbox-data">
								...
								<p>Since insurance are blockchain-based , you need a wallet to create</p>
							</div>
						</div>
					</div>
				</div>
